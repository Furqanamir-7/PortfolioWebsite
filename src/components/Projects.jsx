            ...
            >
              {filtered.map((project, index) => {
                ...
                <motion.article
                  ...
                  layout
                  whileHover={{ y: -6 }}
                  className={`group relative overflow-hidden rounded-3xl border border-accent-glow/60 bg-bg-secondary/60 shadow-card backdrop-blur-xl transition-colors duration-300 hover:border-accent-glow ${
                    centerLastSolo
